...
export default function Testimonial() {
  return (
    <div className="relative text-center py-12 px-4 rounded-lg overflow-hidden">
      <Image
        src="/images/home-cta-background.jpg" // Placeholder - replace with a good background
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        <p className="text-2xl font-semibold italic text-[var(--color-black)] sm:text-3xl">
          "Talking to Bonzah was one of the best decisions I made. They saved me money on my RV and auto insurance!"
        </p>
