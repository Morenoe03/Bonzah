  ...
  return (
    <div className="grid md:grid-cols-2 gap-8 items-center">
      ...
      <div className="flex justify-center items-center rounded-2xl p-8 lg:p-12">
        <Image
          src="/images/rv-hero-image.png" // Placeholder - replace
          alt="RV on the road"
          width={500}
          height={300}
          priority
