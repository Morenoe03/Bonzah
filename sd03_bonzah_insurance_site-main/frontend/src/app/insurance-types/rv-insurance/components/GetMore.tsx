    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p className="mt-4 text-lg text-[var(--color-dark-grey)]">
          Not only can Bonzah ease the stress of getting RV insurance, but we can also save you money (average Bonzah customer who reported savings in 2024 saved $500/yr*). So you can get more of what you want, like:
        </p>
        <ul className="mt-4 space-y-2">
          {["A better campsite", "A new awning", "Mechanical protection", "Or just a lower monthly payment"].map((item) => (
      ...
      <div className="flex justify-center items-center">
        {/* <Image
          src="/images/rv-side-image.png" // Placeholder - replace
          alt="RV at a campsite"
          width={450}
          height={300}
          className="rounded-lg"
        /> */}
        {/* Placeholder for the $1,000 text if desired */}
      </div>
    </div>
  );
}