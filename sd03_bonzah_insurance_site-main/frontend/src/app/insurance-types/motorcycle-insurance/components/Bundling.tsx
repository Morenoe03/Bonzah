    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p className="mt-4 text-[var(--color-dark-grey)] text-lg">
          Everybody knows you get the best insurance deals when you bundle. That's why Bonzah agents are trained to help you save the most by bundling your bike with other policies, like your auto, home, or RV.
        </p>
      ...
      <div className="flex justify-center items-center">
        <Image
          src="/images/friends-riding-image.jpg" // Placeholder - replace
          alt="Friends on motorcycles"
          width={500}
          height={350}
